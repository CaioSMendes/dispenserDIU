...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference("Seller.count") do
      post sellers_url, params: { seller: { cardRFID: @seller.cardRFID, cargo: @seller.cargo, contador: @seller.contador, nome: @seller.nome, status: @seller.status } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { cardRFID: @seller.cardRFID, cargo: @seller.cargo, contador: @seller.contador, nome: @seller.nome, status: @seller.status } }
